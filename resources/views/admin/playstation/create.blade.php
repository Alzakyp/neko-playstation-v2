...
@section('title', 'Create New PlayStation')
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        <div>
                            <h5 class="mb-0">Add New PlayStation</h5>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('ps_number') is-invalid @enderror" type="text"
                                        id="ps_number" name="ps_number" value="{{ old('ps_number') }}" required>
                                    @error('ps_number')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('ps_type') is-invalid @enderror" type="text"
                                        id="ps_type" name="ps_type" value="{{ old('ps_type') }}" list="ps_type_list" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('hourly_rate') is-invalid @enderror" type="number"
                                        id="hourly_rate" name="hourly_rate" value="{{ old('hourly_rate') }}" min="0" step="1000" required>
                                    @error('hourly_rate')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                                ...
                                                @foreach($chunk as $game)
                                                    <div class="form-check mb-2">
                                                        <input class="form-check-input" type="checkbox"
                                                            ...
                                                            name="game_ids[]"
                                                            value="{{ $game->id }}"
                                                            {{ in_array($game->id, old('game_ids', [])) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-12">
                                <button type="submit" class="btn bg-gradient-primary mt-3 btn-lg w-100">
                                    <i class="fas fa-save mr-1"></i> Create PlayStation
                                </button>
                            </div>
                        </div>
                    </form>
